...
pub static COVERAGE_EVIDENCE: &[ApiCoverageEvidence] = &[
    ...
    conformance(
        "kernel32.dll",
        "DeviceIoControl",
        "casa1-conformance:evidence_ps3_kernel32_resources_and_ioctl",
    ),
    conformance(
        "kernel32.dll",
        "GetDateFormatW",
        "casa1-conformance:evidence_ps3_kernel32_date_and_time_formats",
    ),
    conformance(
        "kernel32.dll",
        "GetTimeFormatW",
    ...
    conformance(
        "kernel32.dll",
        "RaiseException",
        "casa1-conformance:evidence_ps3_kernel32_raise_exception_contract",
    ),
    conformance(
        "kernel32.dll",
        "SuspendThread",
        "casa1-conformance:evidence_ps3_kernel32_debugger_affinity_switch_and_suspend",
    ),
    conformance(
        "kernel32.dll",
        "FindResourceA",
    ...
    conformance(
        "kernel32.dll",
        "GetACP",
        "casa1-conformance:evidence_ps3_kernel32_console_codepages_and_std_handles",
    ),
    conformance(
        "kernel32.dll",
        "GetOEMCP",
    ...
    conformance(
        "kernel32.dll",
        "HeapLock",
        "casa1-conformance:evidence_ps3_kernel32_heap_introspection_and_bad_ptr",
    ),
    conformance(
        "kernel32.dll",
        "HeapUnlock",
    ...
    conformance(
        "gdi32.dll",
        "GetDeviceCaps",
        "casa1-conformance:evidence_ps3_gdi_display_text_and_pixel_formats",
    ),
    conformance(
        "gdi32.dll",
        "TextOutW",
    ...
    conformance(
        ...
        "casa1-conformance:evidence_ps3_user32_window_station_and_dialog",
    ),
    conformance(
        "user32.dll",
    ...
    conformance(
        "shell32.dll",
        "IsUserAnAdmin",
        "casa1-conformance:evidence_ps3_shell32_psapi_and_task_memory",
    ),
    conformance(
        "shell32.dll",
        "SHGetFileInfoW",
    ...
    conformance(
        "ole32.dll",
        "CoCreateInstance",
        "casa1-conformance:evidence_ps3_ole32_co_create_instance",
    ),
    conformance(
        "crypt32.dll",
        "CertCreateCertificateContext",
        "casa1-conformance:evidence_ps3_crypt32_certificates",
    ),
    conformance(
        "crypt32.dll",
    ...
    conformance(
        "ws2_32.dll",
        "WSARecv",
        "casa1-conformance:evidence_ps3_ws2_buffered_io",
    ),
    conformance(
        "ws2_32.dll",
        "WSARecvFrom",
