...
pub static COVERAGE_EVIDENCE: &[ApiCoverageEvidence] = &[
    ...
    conformance(
        "d3d11.dll",
        "ID3D11Device",
        "casa1-conformance:test_pe_import_resolution_d3d11",
    ),
    conformance(
        "d3d11.dll",
        "ID3D11DeviceContext",
    ...
    conformance(
        "d3d12.dll",
        "ID3D12Device",
        "casa1-conformance:pe_runtime_d3d12_swapchain_and_command_list_thunks_submit_and_present",
    ),
    conformance(
        "d3d12.dll",
        "ID3D12CommandQueue",
    ...
    conformance("kernel32.dll", "GetACP", "casa1-conformance:section11"),
    conformance(
        "kernel32.dll",
        "GetConsoleCP",
        "casa1-conformance:section11",
    ...
    conformance("kernel32.dll", "GetOEMCP", "casa1-conformance:section11"),
    conformance(
        "kernel32.dll",
        "GetTimeFormatW",
        "casa1-conformance:section11",
    ),
    conformance("kernel32.dll", "HeapLock", "casa1-conformance:section11"),
    conformance(
        "kernel32.dll",
    ...
    conformance("kernel32.dll", "HeapUnlock", "casa1-conformance:section11"),
    conformance(
        "kernel32.dll",
        "HeapValidate",
        "casa1-conformance:section11",
    ),
    conformance("kernel32.dll", "HeapWalk", "casa1-conformance:section11"),
    conformance(
        "kernel32.dll",
        "IsBadWritePtr",
        "casa1-conformance:section11",
    ...
    conformance(
        ...
        "casa1-conformance:section28",
    ),
    conformance("shdocvw.dll", "IWebBrowser2", "casa1-conformance:section28"),
    conformance(
        "mf.dll",
        "MFShutdown",
        "casa1-conformance:evidence_mf_startup_media_type_attributes_and_sample",
    ...
    conformance(
        "x3daudio1_7.dll",
        "X3DAudioCalculate",
        "casa1-conformance:x3daudio_calculate_dispatch_writes_real_dsp_values",
    ),
    conformance(
        "ntdll.dll",
        "NtCreateProcess",
        "casa1-conformance:nt_create_process_creates_real_native_child",
    ),
    conformance(
        "cryptdlg.dll",
        "CertDigestDigest",
        "casa1-conformance:cert_digest_digest_dispatch_writes_known_digests",
    ),
    conformance(
        "cngaudit.dll",
        "CngAuditLog",
        "casa1-conformance:cng_audit_log_appends_real_records",
    ),
    conformance(
        "msftedit.dll",
        "MsftEditRegisterClass",
        "casa1-conformance:rich_edit_register_entries_create_real_windows",
    ),
    conformance(
        "riched32.dll",
