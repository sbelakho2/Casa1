...
pub static COVERAGE_EVIDENCE: &[ApiCoverageEvidence] = &[
    ...
    conformance(
        ...
        "casa1-conformance:evidence_core_srw_lock_thunks_round_trip",
    ),
    conformance(
        "kernel32.dll",
    ...
    conformance(
        "kernel32.dll",
        "Beep",
        "casa1-conformance:evidence_core_misc_kernel32_thunks",
    ),
    conformance(
        "kernel32.dll",
        "CallNamedPipeW",
    ...
    conformance("kernel32.dll", "CloseHandle", "casa1-conformance:section38"),
    conformance(
        "kernel32.dll",
        "CompareFileTime",
    ...
    conformance(
        ...
        "casa1-conformance:evidence_core_fiber_thunks_round_trip",
    ),
    conformance(
        "kernel32.dll",
    ...
    conformance(
        "kernel32.dll",
        "CreateFiber",
        "casa1-conformance:evidence_core_fiber_manager_create_switch_delete",
    ),
    conformance(
        "kernel32.dll",
        "CreateFileA",
    ...
    conformance(
        ...
        "casa1-conformance:evidence_core_iocp_thunks_round_trip",
    ),
    conformance(
        "kernel32.dll",
        "CreateNamedPipeW",
        "casa1-conformance:win32_unit",
    ),
    conformance(
        "kernel32.dll",
        "CreateProcessW",
    ...
    conformance(
        ...
        "casa1-conformance:evidence_core_loader_and_process_info_thunks",
    ),
    conformance(
        "kernel32.dll",
        "FreeLibrary",
    ...
    conformance(
        "kernel32.dll",
        "GetProcessHeap",
        "casa1-conformance:evidence_core_global_heap_thunks_round_trip",
    ),
    conformance(
        "kernel32.dll",
        "GetProcessHeaps",
    ...
    conformance(
        "kernel32.dll",
        "GetStringTypeW",
        "casa1-conformance:evidence_core_string_and_codepage_thunks",
    ),
    conformance(
        "kernel32.dll",
        "GetSystemDirectoryW",
    ...
    conformance(
        ...
        "casa1-conformance:evidence_core_init_once_thunks_round_trip",
    ),
    conformance(
        "kernel32.dll",
        "InitOnceComplete",
    ...
    conformance("kernel32.dll", "OpenProcess", "casa1-conformance:section29"),
    conformance(
        "kernel32.dll",
        "OpenSemaphoreW",
        "casa1-conformance:evidence_core_event_and_semaphore_thunks",
    ...
    conformance("kernel32.dll", "ReadFile", "casa1-conformance:section38"),
    conformance(
        "kernel32.dll",
    ...
    conformance("kernel32.dll", "SetEvent", "casa1-conformance:section50"),
    conformance(
        "kernel32.dll",
        "SetFileAttributesW",
        "casa1-conformance:evidence_core_filesystem_thunks",
    ...
    conformance("kernel32.dll", "Sleep", "casa1-conformance:runtime_unit"),
    conformance("kernel32.dll", "SleepEx", "casa1-conformance:runtime_unit"),
    conformance(
        "kernel32.dll",
        "SwitchToFiber",
        "casa1-conformance:evidence_core_fiber_thunks_round_trip",
    ...
    conformance("kernel32.dll", "TlsFree", "casa1-conformance:runtime_unit"),
    conformance(
        "kernel32.dll",
        "TlsGetValue",
        "casa1-conformance:runtime_unit",
    ...
    conformance("kernel32.dll", "VirtualFree", "casa1-conformance:section50"),
    conformance(
        "kernel32.dll",
        "VirtualProtect",
        "casa1-conformance:runtime_unit",
    ...
    conformance("kernel32.dll", "WriteFile", "casa1-conformance:section38"),
    conformance(
        "kernel32.dll",
    ...
    conformance("ntdll.dll", "LdrAddRefDll", "casa1-conformance:section48"),
    conformance(
        "ntdll.dll",
        "LdrGetDllHandle",
        "casa1-conformance:section48",
    ),
    conformance(
        "ntdll.dll",
    ...
    conformance("ntdll.dll", "LdrLoadDll", "casa1-conformance:section48"),
    conformance(
        "ntdll.dll",
        "LdrLockLoaderLock",
        "casa1-conformance:section48",
    ...
    conformance("ntdll.dll", "LdrUnloadDll", "casa1-conformance:section48"),
    conformance(
        "ntdll.dll",
        "LdrUnlockLoaderLock",
        "casa1-conformance:section48",
    ...
    conformance(
        "ntdll.dll",
        "NtClearEvent",
        "casa1-conformance:ntdll_sync_unit",
    ),
    conformance("ntdll.dll", "NtClose", "casa1-conformance:section50"),
    conformance("ntdll.dll", "NtCreateEvent", "casa1-conformance:section47"),
    conformance("ntdll.dll", "NtCreateFile", "casa1-conformance:section50"),
    conformance("ntdll.dll", "NtCreateKey", "casa1-conformance:section47"),
    conformance(
        "ntdll.dll",
        "NtCreateSection",
        "casa1-conformance:ntdll_loader_unit",
    ),
    conformance(
        "ntdll.dll",
        "NtCreateThreadEx",
        "casa1-conformance:evidence_core_nt_thread_and_process_thunks",
    ),
    conformance(
        "ntdll.dll",
        "NtDelayExecution",
        "casa1-conformance:evidence_core_nt_memory_and_wait_thunks",
    ),
    conformance(
        "ntdll.dll",
        "NtDeleteKey",
        "casa1-conformance:ntdll_registry_unit",
    ),
    conformance(
        "ntdll.dll",
        "NtDeleteValueKey",
    ...
    conformance(
        ...
        "casa1-conformance:evidence_core_nt_rtl_and_io_thunks",
    ),
    conformance(
        "ntdll.dll",
        "NtDuplicateObject",
    ...
    conformance(
        "ntdll.dll",
        "NtEnumerateValueKey",
        "casa1-conformance:evidence_core_nt_enumerate_value_key_lists_values_in_order",
    ),
    conformance(
        "ntdll.dll",
        "NtFreeVirtualMemory",
    ...
    conformance(
        ...
        "casa1-conformance:ntdll_memory_unit",
    ),
    conformance(
        "ntdll.dll",
    ...
    conformance("ntdll.dll", "NtQueryObject", "casa1-conformance:section50"),
    conformance(
        "ntdll.dll",
        "NtQueryPerformanceCounter",
        "casa1-conformance:evidence_core_nt_memory_and_wait_thunks",
    ),
    conformance("ntdll.dll", "NtQuerySection", "casa1-conformance:section50"),
    conformance(
        "ntdll.dll",
    ...
    conformance("ntdll.dll", "NtResumeThread", "casa1-conformance:section49"),
    conformance(
        "ntdll.dll",
        "NtSetContextThread",
        "casa1-conformance:evidence_core_nt_thread_and_process_thunks",
    ),
    conformance("ntdll.dll", "NtSetEvent", "casa1-conformance:section47"),
    conformance(
        "ntdll.dll",
    ...
    conformance("ntdll.dll", "NtSetValueKey", "casa1-conformance:section47"),
    conformance(
        "ntdll.dll",
        "NtSuspendThread",
        "casa1-conformance:section49",
    ...
    conformance(
        ...
        "casa1-conformance:ntdll_rtl_unit",
    ),
    conformance(
        "ntdll.dll",
    ...
    conformance("ntdll.dll", "RtlGetVersion", "casa1-conformance:section50"),
    conformance(
        "ntdll.dll",
        "RtlInitAnsiString",
        "casa1-conformance:evidence_core_nt_rtl_and_io_thunks",
...
mod tests {
    ...
    fn evidence_never_inferred_from_rust_tests() {
        ...
        // a named conformance suite that genuinely exercises the API and
        // asserts its observable behavior.
        ...
        for row in COVERAGE_EVIDENCE {
            if row.evidence_id.starts_with("windows-oracle:") {
                ...
                panic!(
                    "evidence id {} must be windows-oracle:<cat> or \
