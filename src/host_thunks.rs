...
mod tests {
    ...
    fn test_metadata_table_required_quality_stance() {
        ...
        let required_unsupported: Vec<(String, &str)> = THUNK_METADATA
            ...
            .collect();
        // Every Required export is now implemented (the last one fell in the
        // long-tail/final-scraps waves); the set is empty by construction.
        assert!(
            required_unsupported.is_empty(),
            "the Required no-host-thunk set must be empty: {}",
